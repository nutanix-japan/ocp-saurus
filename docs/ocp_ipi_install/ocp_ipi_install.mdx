...
2. Logon to any CVM in your cluster and execute the following to add chosen static IPs to the **Primary** IPAM network
   ...
   ```
   ```bash title="Sample command here"
...
2. Create a configuration file for Prism Central's certificate parameters. Feel free to change your country, state and locality names.
