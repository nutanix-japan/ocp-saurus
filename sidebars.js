module.exports = {
  tutorialSidebar:[
    "intro",
    {
      ...
      items: ['ocp_ntnx_hci/import_bp','ocp_ntnx_hci/prov_vm','ocp_ntnx_hci/ocp_vms','ocp_ntnx_hci/ocp_scale_out_in','ocp_ntnx_hci/ocp_csi','optional_labs/ocp_image_registry'],
    },
    {
      type: 'category',
